...
void next(){
    ...
    if(m1x<2){rx=m1x; ry=m1y;}
    if(m2x<2){rx=m2x; ry=m2y;}
    if(m3x<2){rx=m3x; ry=m3y;}
    x+=rx; y+=ry;
    sizeImpuls01++;
    Ireset=false;
}
...
int mountainX(int mx,int my,int x, int y) {
    ...
    if(d1==1&&M1x>=x&&M1y>=y){
        ...
        if(M1x>x&&M1y>y){return 01;}
        else if(M1x>x){return 0;}
        else{return 1;}
    }
    else{return 2;}
}
...
int mountainY(int mx,int my,int x, int y) {
    ...
    if(d1==1&&M1x>=x&&M1y>=y){
        ...
        if(M1x>x&&M1y>y){return 0;}
        else if(M1x>y){return 0;}
        else{return 1;}
    }
...
void animate(){
    ...
    else{index01=0;setcol();}
}

void setcol() {
    if(countRe>=sizeImpuls01&&sizeImpuls01>3){Ireset=true;}
    for(int i=sizeImpuls01-1;i>=0;i--){
        if(red>0x000600){
            red-=0x000500; blue+=0x000005;
        }
        else if(input>30){
            red=0x000000; blue=0x0000FF;
        }
        else if(blue>0x000045){
            red=0x000000; blue-=0x000044;
        }
        else {red=0x000000; blue=0x000000; countRe++;}
        colors[i]=red+blue;}
}

void reset(int ix, int iy){
    x=ix; y=iy; sizeImpuls01=0; index01=0;
    red=0x00FF00; blue=0x0000FF; start=false; countRe=0; Ireset=false;
}
